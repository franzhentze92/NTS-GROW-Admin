...
export const CROP_OPTIONS = [
  ...
  { id: '61', name: 'Buffaloberries' },
  { id: '62', name: 'Silverberries' },
  { id: '63', name: 'Autumn Olives' },
  { id: '64', name: 'Russian Olives' },
  { id: '65', name: 'Sea Buckthorns' },
  { id: '66', name: 'Wolfberries' },
  { id: '67', name: 'Goumi Berries' },
  { id: '68', name: 'Noni' },
  { id: '69', name: 'Acerola' },
  { id: '70', name: 'Camu Camu' },
  { id: '71', name: 'Tamarillo' },
  { id: '72', name: 'Tree Tomato' },
  { id: '73', name: 'Cape Gooseberry' },
  { id: '74', name: 'Ground Cherry' },
  { id: '75', name: 'Tomatillo' },
  { id: '76', name: 'Physalis' },
  { id: '77', name: 'Goldenberry' },
  { id: '78', name: 'Inca Berry' },
  { id: '79', name: 'Poha Berry' },
  { id: '80', name: 'Husk Cherry' },
  { id: '81', name: 'Strawberry Tomato' },
  { id: '82', name: 'Chinese Lantern' },
  { id: '83', name: 'Winter Cherry' },
  { id: '84', name: 'Bladder Cherry' },
  { id: '85', name: 'Japanese Lantern' },
  { id: '86', name: 'Alkekengi' },
  { id: '87', name: 'Peruvian Ground Cherry' },
  { id: '88', name: 'Dwarf Cape Gooseberry' },
  { id: '89', name: 'Giant Ground Cherry' },
  { id: '90', name: 'Purple Ground Cherry' },
  { id: '91', name: 'Yellow Ground Cherry' },
  { id: '92', name: 'Red Ground Cherry' },
  { id: '93', name: 'Orange Ground Cherry' },
  { id: '94', name: 'White Ground Cherry' },
  { id: '95', name: 'Black Ground Cherry' },
  { id: '96', name: 'Green Ground Cherry' },
  { id: '97', name: 'Blue Ground Cherry' },
  { id: '98', name: 'Pink Ground Cherry' },
  { id: '99', name: 'Brown Ground Cherry' },
  { id: '100', name: 'Gray Ground Cherry' },
