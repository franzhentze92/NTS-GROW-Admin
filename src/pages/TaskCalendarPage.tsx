...
import { RefreshCw, AlertCircle, ChevronsUpDown, ArrowUp, ArrowDown } from 'lucide-react';
            ...
            <div>
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-1">A visual timeline of all project tasks.</p>
                    </div>
